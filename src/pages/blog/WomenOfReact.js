        ...
        <Container fluid={true} className="blog-article">
            <Row>
                <Col>
                    ...
                    <h6>
                        <i>
                            Important elements of a Design Dystem
                        </i>
                    </h6>
                    <p>
                        <strong>
                    ...
                    <ul>
                        <li>
                            Fast refresh to solve hot reloading.</li>
                        <li>

                            Inspect and filter props to remove all the console.log().</li>
                        <li>

                            Get full hook support.</li>
                        <li>
                    ...
                    <p>Eve live coded an App to distribute weight between her backpack and her husband’s when they go hiking.</p>
